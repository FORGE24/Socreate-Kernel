...
Source99: apply-anaconda-socreate.sh
Source100: anaconda-profile-socreate.conf

# partitioning: manual: skip requests for devices removed from device tree in setup_kickstart
Patch: 6767.patch
# Socreate branding is applied post-%prep by scripts/ci/apply-anaconda-socreate.sh
